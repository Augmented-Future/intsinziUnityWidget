...
class TvzoneTwoCardPageView extends StatefulWidget {
  const TvzoneTwoCardPageView({Key? key}) : super(key: key);

  @override
  _TvzoneTwoCardPageViewState createState() => _TvzoneTwoCardPageViewState();
}

class _TvzoneTwoCardPageViewState extends State<TvzoneTwoCardPageView> {
